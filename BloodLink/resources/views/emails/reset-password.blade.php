                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="color: #2d3748; margin: 0 0 16px 0; font-size: 22px;">Reset Your Password</h2>
                            <p style="color: #718096; line-height: 1.6; margin: 0 0 24px 0;">
                                Hello <strong style="color: #2d3748;">{{ $user->name }}</strong>,<br><br>
                                We received a request to reset the password for your BloodLink account. Click the button below to set a new password.
                            </p>
                            <table cellpadding="0" cellspacing="0" style="margin: 0 auto 32px auto;">
                                <tr>
                                    <td style="background-color: #e53e3e; border-radius: 6px; text-align: center;">
                                        <a href="{{ $resetUrl }}" style="display: inline-block; padding: 14px 36px; color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 600; letter-spacing: 0.5px;">Reset Password</a>
                                    </td>
                                </tr>
                            </table>
